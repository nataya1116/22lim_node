...
image.src = '/img/game_image/background/backGroundBeforeStg1.png';

const foregroundImage = new Image()
foregroundImage.src = '/img/game_image/background/foreGroundBeforeStg1.png';
//20220710 통 플레이어 이미지
const playerImage = new Image();
playerImage.src = '/img/game_image/character/$Dr Frankenstien (resizing).png';

const knifeImage1 = new Image();
knifeImage1.src = '/img/game_image/playimage/knife.png';

const knifeImage2 = new Image();
knifeImage2.src = '/img/game_image/playimage/knife.png';
...
awlImageShort.src = '/img/game_image/playImage/awl_1.png';

const awlImageMedium = new Image();
awlImageMedium.src = '/img/game_image/playImage/awl_2.png';

const awlImageLong = new Image();
awlImageLong.src = '/img/game_image/playImage/awl_3.png';
